package vn.spring.jobhunter.util;
...
public class SecurityUtil {
    ...
    public static boolean hasCurrentUserNoneOfAuthorities(String... authourities) {
        return !hasCurrentUserAnyOfAuthorities(authourities);
    }
